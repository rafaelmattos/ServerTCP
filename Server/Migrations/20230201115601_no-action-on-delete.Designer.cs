...
namespace Server.Migrations
{
    ...
    [Migration("20230201115601_no-action-on-delete")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Linguagens", b =>
                {
            ...
            modelBuilder.Entity("Server.Models.UserCliente", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "ClienteId");

                    b.HasIndex("ClienteId");

                    b.ToTable("UserClientes");
                });

            modelBuilder.Entity("Server.Models.ViewModels.TransacoesViewModel", b =>
                {
                    b.Property<int?>("ClienteId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Server.Models.XmlModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Server.Cliente", b =>
                {
                    b.HasOne("Server.Cliente", "ClientePai")
                        .WithMany("Clientes")
                        .HasForeignKey("ClientePaiId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Server.Models.UserCliente", b =>
                {
                    b.HasOne("Server.Cliente", "Cliente")
                        .WithMany("UsersCliente")
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Server.Models.AppUser", "User")
                        .WithMany("UserClientes")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Server.Models.ViewModels.TransacoesViewModel", b =>
                {
                    ...
                    b.HasOne("Server.Equipamento", "Equipamento")
                        .WithMany()
